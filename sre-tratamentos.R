...
grp_lik4_77 <- c("V07","V14","V17","V18","V19","V25","V27",
                 ...
                 "V60","V61","V62","V64",
                 "V65", # VARIAVEIS QUE ESTAVAM FALTANDO
                 "V67","V68","V69","V70","V71","V72","V73","V74","V75","V76",
                 "V77","V78", # VARIAVEIS QUE ESTAVAM FALTANDO
...
sre_medias <- add_ratio_zero(sre_medias,
                             c("V24_3_ajustada","V24_4_ajustada","V24_5_ajustada"), # estava com duplicidade
                             "V24_3_4_5_media")
...
# limpar pares antigos para evitar colisões
...
descritores_sre_see <- add_descritor_ratio_zero(descritores_sre_see, c("V13_ajustada"), "E3D2_18")

descritores_sre_see <- add_descritor_ratio_zero(descritores_sre_see, c("V53_1_12_ajustada"), "E3D3_22")
descritores_sre_see <- add_descritor_ratio_zero(descritores_sre_see, c("V61_ajustada"), "E3D3_24")

descritores_sre_see <- add_descritor_ratio_zero(descritores_sre_see, c("V45_5_ajustada","V46_5_ajustada"), "E3D4_26")
descritores_sre_see <- add_descritor_ratio_zero(descritores_sre_see, c("V56_ajustada","V57_ajustada","V58_ajustada"), "E3D4_27")
descritores_sre_see <- add_descritor_ratio_zero(descritores_sre_see, c("V56_ajustada","V57_ajustada","V58_ajustada"), "E3D4_28")
descritores_sre_see <- add_descritor_ratio_zero(descritores_sre_see, c("V45_4_ajustada","V46_4_ajustada"), "E3D4_29")
descritores_sre_see <- add_descritor_ratio_zero(descritores_sre_see, c("V56_ajustada","V57_ajustada","V58_ajustada"), "E3D4_30")
descritores_sre_see <- add_descritor_ratio_zero(descritores_sre_see, c("V56_ajustada","V57_ajustada","V58_ajustada"), "E3D4_31")

descritores_sre_see <- add_descritor_ratio_zero(descritores_sre_see, c("V23_ajustada"), "E3D5_33")
descritores_sre_see <- add_descritor_ratio_zero(descritores_sre_see, c("V103_3_ajustada"), "E3D5_36")

# ----- E4*
descritores_sre_see <- add_descritor_ratio_zero(descritores_sre_see, c("V72_ajustada"), "E4D1_1")
descritores_sre_see <- add_descritor_ratio_zero(descritores_sre_see, c("V28_1_2_3_3_4_5_6_7_ajustada"), "E4D1_2")

descritores_sre_see <- add_descritor_ratio_zero(descritores_sre_see, c("V53_3_4_6_ajustada","V55_3_4_6_ajustada"), "E4D2_5")
descritores_sre_see <- add_descritor_ratio_zero(descritores_sre_see, c("V25_ajustada"), "E4D2_8")

descritores_sre_see <- add_descritor_ratio_zero(descritores_sre_see, c("V24_3_4_5_ajustada"), "E4D3_14")
descritores_sre_see <- add_descritor_ratio_zero(descritores_sre_see, c("V27_ajustada"), "E4D3_16")
descritores_sre_see <- add_descritor_ratio_zero(descritores_sre_see, c("V62_ajustada"), "E4D3_17")

descritores_sre_see <- add_descritor_ratio_zero(descritores_sre_see, c("V56_ajustada","V57_ajustada","V58_ajustada"), "E4D4_19")
descritores_sre_see <- add_descritor_ratio_zero(descritores_sre_see, c("V56_ajustada","V57_ajustada","V58_ajustada"), "E4D4_20")
descritores_sre_see <- add_descritor_ratio_zero(descritores_sre_see, c("V45_8_9_ajustada","V46_8_9_ajustada"), "E4D4_21")
descritores_sre_see <- add_descritor_ratio_zero(descritores_sre_see, c("V45_10_11_12_ajustada","V46_10_11_12_ajustada"), "E4D4_22")

descritores_sre_see <- add_descritor_ratio_zero(descritores_sre_see, c("V30_ajustada"), "E4D5_24")
descritores_sre_see <- add_descritor_ratio_zero(descritores_sre_see, c("V101_4_ajustada"), "E4D5_25")


# ----- E5*
descritores_sre_see <- add_descritor_ratio_zero(descritores_sre_see, c("V65_ajustada"), "E5D1_1")
descritores_sre_see <- add_descritor_ratio_zero(descritores_sre_see, c("V31_ajustada"), "E5D1_3")

descritores_sre_see <- add_descritor_ratio_zero(descritores_sre_see, c("V32_ajustada"), "E5D2_5")
descritores_sre_see <- add_descritor_ratio_zero(descritores_sre_see, c("V76_ajustada"), "E5D2_6")
descritores_sre_see <- add_descritor_ratio_zero(descritores_sre_see, c("V34_ajustada"), "E5D2_8")
descritores_sre_see <- add_descritor_ratio_zero(descritores_sre_see, c("V33_ajustada"), "E5D2_10")
descritores_sre_see <- add_descritor_ratio_zero(descritores_sre_see, c("V53_8_9_ajustada","V55_8_9_ajustada"), "E5D2_12")

descritores_sre_see <- add_descritor_ratio_zero(descritores_sre_see, c("V45_20_ajustada","V46_20_ajustada","V50_ajustada"), "E5D3_13")
descritores_sre_see <- add_descritor_ratio_zero(descritores_sre_see, c("V67_ajustada"), "E5D3_14")
descritores_sre_see <- add_descritor_ratio_zero(descritores_sre_see, c("V48_ajustada"), "E5D3_15")
descritores_sre_see <- add_descritor_ratio_zero(descritores_sre_see, c("V51_ajustada"), "E5D3_16")
descritores_sre_see <- add_descritor_ratio_zero(descritores_sre_see, c("V49_ajustada","V66_ajustada"), "E5D3_18")

descritores_sre_see <- add_descritor_ratio_zero(descritores_sre_see, c("V56_ajustada","V57_ajustada","V58_ajustada"), "E5D4_19")
descritores_sre_see <- add_descritor_ratio_zero(descritores_sre_see, c("V45_13_14_ajustada","V46_13_14_ajustada"), "E5D4_20")

descritores_sre_see <- add_descritor_ratio_zero(descritores_sre_see, c("V35_ajustada"), "E5D5_22")
descritores_sre_see <- add_descritor_ratio_zero(descritores_sre_see, c("V101_5_ajustada"), "E5D5_23")


# ----- E6*
descritores_sre_see <- add_descritor_ratio_zero(descritores_sre_see, c("V42_ajustada","V43_ajustada"), "E6D1_2")

descritores_sre_see <- add_descritor_ratio_zero(descritores_sre_see, c("V75_ajustada"), "E6D2_4")
descritores_sre_see <- add_descritor_ratio_zero(descritores_sre_see, c("V37_ajustada"), "E6D2_5")
descritores_sre_see <- add_descritor_ratio_zero(descritores_sre_see, c("V36_1_2_3_4_5_6_7_ajustada"), "E6D2_8")
descritores_sre_see <- add_descritor_ratio_zero(descritores_sre_see, c("V38_ajustada"), "E6D2_11")
descritores_sre_see <- add_descritor_ratio_zero(descritores_sre_see, c("V39_ajustada","V40_ajustada"), "E6D2_14")
descritores_sre_see <- add_descritor_ratio_zero(descritores_sre_see, c("V45_16_ajustada","V46_16_ajustada"), "E6D2_16")
descritores_sre_see <- add_descritor_ratio_zero(descritores_sre_see, c("V53_10_11_7_ajustada","V55_10_11_7_ajustada"), "E6D2_17")

descritores_sre_see <- add_descritor_ratio_zero(descritores_sre_see, c("V60_ajustada"), "E6D3_18")

descritores_sre_see <- add_descritor_ratio_zero(descritores_sre_see, c("V45_15_17_ajustada","V46_15_17_ajustada"), "E6D4_21")
descritores_sre_see <- add_descritor_ratio_zero(descritores_sre_see, c("V84_ajustada"), "E6D4_23")

descritores_sre_see <- add_descritor_ratio_zero(descritores_sre_see, c("V44_ajustada"), "E6D5_26")
descritores_sre_see <- add_descritor_ratio_zero(descritores_sre_see, c("V101_6_ajustada"), "E6D5_27")
...
################## por regional ################
################################################
agregado_por_see_sre.sre <- sre_medias %>%
  mutate(ATOR = "2. Técnico SRE") %>%   
  select(-any_of("SEE")) %>%            
  rename(
    SEE = SEE_rotulo,
    SRE = sre
  ) %>%
  group_by(ATOR, SEE, SRE) %>%
  summarise(
    across(all_of(cols_existentes), ~ mean(.x, na.rm = TRUE)),
    .groups = "drop"
  )
...
posicoes <- match(cols_existentes, names(agregado_por_see_sre.sre))
names(agregado_por_see_sre.sre)[posicoes] <- alias_vec

# garantir nomes únicos
stopifnot(anyDuplicated(names(agregado_por_see_sre.sre)) == 0)
...
# 1) Capturar TODAS as colunas que terminam com _ajustada
ajustadas_cols_see_sre <- grep("_ajustada$", names(agregado_por_see_sre.sre), value = TRUE)

# (opcional) limpar pares antigos para evitar colisões
agregado_por_see_sre <- agregado_por_see_sre.sre %>%
  select(-any_of(paste0(ajustadas_cols_see_sre, "_numerador")),
         -any_of(paste0(ajustadas_cols_see_sre, "_denominador")))

# 2) Criar num/den exatamente como no SQL do SRE (ELSE 0.0 em ambos)
agregado_por_see_sre_nd <- agregado_por_see_sre.sre %>%
  mutate(
    across(
      all_of(ajustadas_cols_see_sre),
      ~ ifelse(!is.na(.x), as.numeric(.x), 0.0),
...
# Aplicação literal do SQL
# ---------------------------
descritores_sre_see.sre <- agregado_por_see_sre_nd

# ----- A2*
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V87_ajustada"), "A2D1_2")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V85_ajustada"), "A2D2_3")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V63_ajustada"), "A2D2_8")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V88_ajustada"), "A2D3_6")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V89_ajustada","V90_ajustada"), "A2D3_7")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V86_ajustada"), "A2D3_9")

# ----- A3*
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V92_ajustada","V93_ajustada","V95_ajustada"), "A3D1_1")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V96_ajustada","V97_ajustada"), "A3D1_2")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V98_ajustada"), "A3D2_3")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V55_12_ajustada"), "A3D2_5")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V94_ajustada"), "A3D3_7")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V99_ajustada"), "A3D4_8")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V56_ajustada","V57_ajustada","V58_ajustada"), "A3D4_9")


# ----- A4*
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V12_ajustada"), "A4D1_2")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V70_ajustada"), "A4D1_3")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V71_ajustada"), "A4D1_4")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V17_ajustada"), "A4D1_5")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V74_ajustada"), "A4D1_7")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V77_ajustada"), "A4D2_9")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V27_ajustada"), "A4D3_12")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V24_3_4_5_ajustada"), "A4D3_14")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V45_4_ajustada","V46_4_ajustada"), "A4D4_18")
# Trinca repetida no SQL com rótulos distintos
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V56_ajustada","V57_ajustada","V58_ajustada"), "A4D4_19")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V56_ajustada","V57_ajustada","V58_ajustada"), "A4D4_20")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V56_ajustada","V57_ajustada","V58_ajustada"), "A4D4_21")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V45_8_9_ajustada"), "A4D4_22")


# ----- E1*
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V78_ajustada"), "E1D1_1")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V80_ajustada"), "E1D1_2")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V07_ajustada"), "E1D1_4")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V01_ajustada","V02_ajustada","V03_ajustada"), "E1D1_5")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V14_ajustada"), "E1D2_10")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V09_6_7_ajustada"), "E1D2_6")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V68_ajustada"), "E1D2_7")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V08_ajustada"), "E1D4_15")


# ----- E2*
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V05_ajustada","V81_ajustada"), "E2D1_1")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V09_1_10_11_3_8_ajustada"), "E2D1_11")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V69_ajustada"), "E2D1_12")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V04_ajustada"), "E2D1_3")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V12_ajustada"), "E2D1_5")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V70_ajustada"), "E2D1_6")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V09_9_ajustada"), "E2D1_8")

descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V11_1_2_3_4_5_6_7_ajustada"), "E2D2_14")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V53_2_ajustada","V55_2_ajustada"), "E2D2_16")

descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V45_1_2_7_ajustada"), "E2D3_17")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V83_ajustada"), "E2D3_19")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V15_ajustada"), "E2D3_20")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V60_ajustada"), "E2D3_21")

descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V06_ajustada","V82_ajustada"), "E2D4_22")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V45_3_ajustada","V46_3_ajustada","V47_ajustada"), "E2D4_23")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V56_ajustada","V57_ajustada","V58_ajustada"), "E2D4_24")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V59_1_2_3_4_ajustada"), "E2D4_25")

# Duplicidade (2x) no SQL para V09_2_4
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V09_2_4_ajustada","V09_2_4_ajustada"), "E2D4_28")

descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V16_ajustada"), "E2D5_30")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V101_2_ajustada"), "E2D5_31")


# ----- E3*
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V71_ajustada"), "E3D1_10")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V18_ajustada"), "E3D1_3")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V20_1_2_3_4_5_6_ajustada","V21_ajustada","V22_ajustada"), "E3D1_5")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V17_ajustada"), "E3D1_8")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V74_ajustada"), "E3D1_9")

descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V19_ajustada"), "E3D2_12")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V13_ajustada"), "E3D2_18")

descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V53_1_12_ajustada"), "E3D3_22")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V61_ajustada"), "E3D3_24")

descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V45_5_ajustada","V46_5_ajustada"), "E3D4_26")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V56_ajustada","V57_ajustada","V58_ajustada"), "E3D4_27")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V56_ajustada","V57_ajustada","V58_ajustada"), "E3D4_28")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V45_4_ajustada","V46_4_ajustada"), "E3D4_29")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V56_ajustada","V57_ajustada","V58_ajustada"), "E3D4_30")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V56_ajustada","V57_ajustada","V58_ajustada"), "E3D4_31")

descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V23_ajustada"), "E3D5_33")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V103_3_ajustada"), "E3D5_36")

# ----- E4*
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V72_ajustada"), "E4D1_1")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V28_1_2_3_3_4_5_6_7_ajustada"), "E4D1_2")

descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V53_3_4_6_ajustada","V55_3_4_6_ajustada"), "E4D2_5")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V25_ajustada"), "E4D2_8")

descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V24_3_4_5_ajustada"), "E4D3_14")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V27_ajustada"), "E4D3_16")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V62_ajustada"), "E4D3_17")

descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V56_ajustada","V57_ajustada","V58_ajustada"), "E4D4_19")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V56_ajustada","V57_ajustada","V58_ajustada"), "E4D4_20")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V45_8_9_ajustada","V46_8_9_ajustada"), "E4D4_21")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V45_10_11_12_ajustada","V46_10_11_12_ajustada"), "E4D4_22")

descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V30_ajustada"), "E4D5_24")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V101_4_ajustada"), "E4D5_25")


# ----- E5*
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V65_ajustada"), "E5D1_1")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V31_ajustada"), "E5D1_3")

descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V32_ajustada"), "E5D2_5")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V76_ajustada"), "E5D2_6")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V34_ajustada"), "E5D2_8")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V33_ajustada"), "E5D2_10")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V53_8_9_ajustada","V55_8_9_ajustada"), "E5D2_12")

descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V45_20_ajustada","V46_20_ajustada","V50_ajustada"), "E5D3_13")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V67_ajustada"), "E5D3_14")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V48_ajustada"), "E5D3_15")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V51_ajustada"), "E5D3_16")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V49_ajustada","V66_ajustada"), "E5D3_18")

descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V56_ajustada","V57_ajustada","V58_ajustada"), "E5D4_19")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V45_13_14_ajustada","V46_13_14_ajustada"), "E5D4_20")

descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V35_ajustada"), "E5D5_22")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V101_5_ajustada"), "E5D5_23")


# ----- E6*
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V42_ajustada","V43_ajustada"), "E6D1_2")

descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V75_ajustada"), "E6D2_4")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V37_ajustada"), "E6D2_5")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V36_1_2_3_4_5_6_7_ajustada"), "E6D2_8")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V38_ajustada"), "E6D2_11")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V39_ajustada","V40_ajustada"), "E6D2_14")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V45_16_ajustada","V46_16_ajustada"), "E6D2_16")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V53_10_11_7_ajustada","V55_10_11_7_ajustada"), "E6D2_17")

descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V60_ajustada"), "E6D3_18")

descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V45_15_17_ajustada","V46_15_17_ajustada"), "E6D4_21")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V84_ajustada"), "E6D4_23")

descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V44_ajustada"), "E6D5_26")
descritores_sre_see.sre <- add_descritor_ratio_zero(descritores_sre_see.sre, c("V101_6_ajustada"), "E6D5_27")

# =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
# pivotagem ator sre
# =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
sre_descritores_agregado <- descritores_sre_see.sre
...
# Pivot: wide -> long (equivalente ao UNPIVOT do SQL)
sre_descritores_long_sre <- sre_descritores_agregado %>%
  pivot_longer(
    cols      = all_of(descritores_exist_sre),
    names_to  = "descritor",
    values_to = "valor"
...
# tabela final regional
final.descritores.sre <- sre_descritores_long_sre %>%
  select(SEE, SRE, ATOR, descritor, valor)

# base final selecionada - sre
final.descritores.see = sre_descritores_long_see %>% 
  select(SEE, SRE, ATOR, descritor, valor)

# empilhar ambas
final.descritores.sre = bind_rows(final.descritores.see, final.descritores.sre)

saveRDS(final.descritores.sre, "final.descritores.sre.R")

#exportar excel
writexl::write_xlsx(final.descritores.sre, "final.descritores.sre.xlsx")
